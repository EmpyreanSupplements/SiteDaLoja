                  ...
                  <img id="pencil-square" src="pencil-square.svg"/>
                    ...
                    <form>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-pill p-2 mb-3 bg-white rounded  mt-2" id="nome" name="nome" required/>
                      </div>
                      <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" class="form-control rounded-pill p-2 mb-3 bg-white rounded mt-2" id="email" name="email" required/>
                      </div>
                      <div class="form-group">
                        <label for="senha">Senha:</label>
                        <input type="password" class="form-control rounded-pill p-2 mb-3 bg-white rounded mt-2" id="senha" name="senha" required/>
                      </div>
                      <div class="form-group">
                        <label for="endereco">CPF:</label>
                        <input type="text" class="form-control rounded-pill p-2 mb-3 bg-white rounded mt-2" id="cpf" name="cpf" required/>
                      </div>
                      <div class="form-group">
                        <label for="estado">Estado:</label>
                        <input type="text" class="form-control rounded-pill p-2 mb-3 bg-white rounded mt-2" id="estado" name="estado" required/>
                      </div>
                      <div class="form-group">
                        <label for="cidade">Cidade:</label>
                        <input type="text" class="form-control rounded-pill p-2 mb-5 bg-white rounded mt-2" id="cidade" name="cidade" required/>
                      </div>
